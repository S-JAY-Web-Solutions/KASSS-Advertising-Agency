                ...
                <div class="bottom">
                    <div class="contact-forms">
                        <div class="form-view">
                            ...
                            <?php   }   ?>
                            <div class="form-btn">
                                <a href="contact.php"><button type="submit" id="back-btn" name="update">Back </button></a>
                                <a href="reply.php?id=<?php echo"$contact_id"; ?>"><button type="submit" id="reply-btn" name="reply">Reply </button></a>
                                <a href="action.inc.php?id=<?php echo"$contact_id"; ?>&delete=true"><button type="submit" id="delete-btn" name="delete">Delete </button></a>
                            </div>
                        </div>
                    </div>
                </div>
