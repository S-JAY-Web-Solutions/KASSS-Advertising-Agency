...
if (isset($_GET['id'])) {
    ...
    $search = mysqli_query($conn,"SELECT * FROM quotation WHERE id='$quotation_id';");
        ...
        <div class="container">
            <div class="side-nav">
                ...
                <ul class="side-nav-bar">
                    ...
                    <a href="quotation.php" class="side-nav-link"><li class="side-nav-item sub-active">Manage Quotations</li></a>
                    <a href="packages.php" class="side-nav-link"><li class="side-nav-item">Manage Packages</li></a>

                    <a href="logout.html" class="side-nav-link"><li class="side-nav-item side-nav-logout">Logout &nbsp<i class="fa fa-sign-out"></i></li></a>
                </ul>
            </div>
            <div class="content">
                <div class="top">
                    ...
                    <div class="contact-forms">
                        <div class="form-view">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="phonenumber" name="phonenumber" value="<?php echo htmlspecialchars($searchrow['phoneNumber'] ?? ''); ?>" readonly>
                            </div>
                            <div class="form-group">
                            ...
                            if($searchrow['status'] == 1){ ?>
                                <div class="form-group">
                                    ...
                                    <input type="text" id="reply" name="reply" value="<?php echo htmlspecialchars($searchrow['reply'] ?? ''); ?>" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="reply_date">Reply Date</label><br>
                                    <input type="text" id="reply_date" name="reply_date" value="<?php echo htmlspecialchars($searchrow['reply_date'] ?? ''); ?>" readonly>
                                </div>
                            <?php   }   ?>
                            <div class="form-btn">
                                <a href="quotation.php"><button type="submit" id="back-btn" name="update">Back </button></a>
                                <a href="replyquotation.php?id=<?php echo"$quotation_id"; ?>"><button type="submit" id="reply-btn" name="reply">Reply </button></a>
                                <a href="quotation.inc.php?id=<?php echo"$quotation_id"; ?>&delete=true"><button type="submit" id="delete-btn" name="delete">Delete </button></a>
                            </div>
                        </div>
                    </div>
                </div>
