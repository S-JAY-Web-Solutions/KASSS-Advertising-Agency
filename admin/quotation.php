...
$search = mysqli_query($conn,"SELECT * FROM quotation;");
                                        ...
                                        echo "<tr>
                                            ...
                                            echo"</td>
                                                <td><div class='action_btn'>
                                                        <a href='viewquotation.php?id=".$searchresult["id"]."'><i class='fa fa-eye'></i></a>
                                                        <a href='replyquotation.php?id=".$searchresult["id"]."'><i class='fa fa-reply'></i></a>
                                                        <a href='quotation.inc.php?id=".$searchresult["id"]."&move=true'  id='tick'><i class='fa fa-check'></i></a>
                                                        <a href='quotation.inc.php?id=".$searchresult["id"]."&delete=true' id='delete'><i class='fa fa-trash'></i></a>
                                                    </div>
                                                </td>
                                            </tr>";
                                    }
