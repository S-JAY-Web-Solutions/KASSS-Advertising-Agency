            ...
            <div class="content">
                ...
                <div class="bottom">
                    <div class="contact-forms">
                        <div class="form-view">
                            <form action="quotation.inc.php" method="POST">
                            ...
                            <div class="form-btn">
                                <a href="quotation.php" id="back-btn">Back</a>
                                <button type="submit" id="reply-btn" name="reply">Reply </button>
                                <a href="quotation.inc.php?id=<?php echo"$quotation_id"; ?>&delete=true" id="delete-btn">Delete</a>                            
                            </div>
                        </div>
                    </div>
                </div>
